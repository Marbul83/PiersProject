pipeline{
        ...
        stages{
                stage('--Front End--'){
                        steps{
                                sh '''image="35.234.150.82:5000/frontend:build-${BUILD_NUMBER}"
                ...
                stage('--Service1--'){
                        steps{
                                sh '''image="35.234.150.82:5000/rand1:build-${BUILD_NUMBER}"
                ...
                stage('--Service2--'){
                        steps{
                                sh '''image="35.234.150.82:5000/rand2:build-${BUILD_NUMBER}"
                ...
                stage('--Back End--'){
                        steps{
                                sh '''image="35.234.150.82:5000/backend:build-${BUILD_NUMBER}"
